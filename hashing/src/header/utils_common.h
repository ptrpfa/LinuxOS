/* Imports */
// Conditional import depending on whether on program type (user or kernel)
#ifdef USER_SPACE
...
// Conditional type definition depending on whether on program type (user or kernel)
#ifdef USER_SPACE
...
// Type definition of different hash types enumerated
